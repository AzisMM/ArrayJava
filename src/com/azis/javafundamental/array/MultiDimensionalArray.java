...
public class MultiDimensionalArray {
    public static void main(String[] args) {
        ...
        System.out.println("Dimensi 1 dengan indeks 1 dan Dimensi 3 dengan indeks 0 : " + arrChar[1][0]);
        System.out.println("Dimensi 1 dengan indeks 1 dan Dimensi 3 dengan indeks 1 : " + arrChar[1][1]);
        System.out.println("Dimensi 1 dengan indeks 1 dan Dimensi 3 dengan indeks 2 : " + arrChar[1][2]);
